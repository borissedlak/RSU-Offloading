...
"""
source: https://github.com/philtabor/Youtube-Code-Repository/blob/master/ReinforcementLearning/PolicyGradient/TD3/td3_torch.py
Modified to work without a Gym environment by Andrea Morichetta
"""
class ReplayBuffer():
...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau,
                 #env, #removing env in this case to manually specify min and max action value
                 low_action_value=0, high_action_value=1,
                 gamma=0.99, update_actor_interval=2, warmup=1000,
                 n_actions=1, # Number of action = 1 (only one decision at a time in our use case (offload or not)
                 max_size=1000000, layer1_size=400,
                 layer2_size=300, batch_size=100, noise=0.1):
        self.gamma = gamma
        self.tau = tau
        self.max_action = high_action_value
        self.min_action = low_action_value
